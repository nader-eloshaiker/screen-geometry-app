...
import {
  configDefaults,
  defineConfig,
} from 'file:///Users/nadereloshaiker/Development/Personal/screen-geometry-app/node_modules/.pnpm/vitest@1.1.2_@types+node@20.11.2_@vitest+ui@1.2.0_jsdom@23.0.1/node_modules/vitest/dist/config.js'
...
var package_default = {
  ...
  scripts: {
    ...
    'test:badge':
      'coverage-badges-cli --source=reports/coverage/coverage-summary.json --output=docs/coverage.svg --icon=docs/vitest.svg',
