        ...
        primary: {
          ...
          foreground: {
            ...
            input: {
              ...
              hover:
                "hsl(var(--primary-foreground-input-hover) / <alpha-value>)",
            },
          },
          border: {
        ...
        danger: {
          ...
          foreground: {
            ...
            input: {
              ...
              hover:
                "hsl(var(--danger-foreground-input-hover) / <alpha-value>)",
            },
          },
          border: {
        ...
        success: {
          ...
          foreground: {
            ...
            input: {
              ...
              hover:
                "hsl(var(--success-foreground-input-hover) / <alpha-value>)",
            },
          },
          border: {
        ...
        warning: {
          ...
          foreground: {
            ...
            input: {
              ...
              hover:
                "hsl(var(--warning-foreground-input-hover) / <alpha-value>)",
            },
          },
          border: {
