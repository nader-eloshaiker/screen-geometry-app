...
export const CheckboxVariants = cva(
  'shadow-xs outline-hidden focus-visible:outline-hidden peer shrink-0 rounded-sm border-2 hover:cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-4 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      palette: {
        primary:
