...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@local/assets': path.resolve(__dirname, '/src/app/assets'),
      '@local/components': path.resolve(__dirname, '/src/app/components'),
      '@local/constants': path.resolve(__dirname, '/src/app/constants'),
      '@local/contexts': path.resolve(__dirname, '/src/app/contexts'),
      '@local/hooks': path.resolve(__dirname, './src/app/hooks'),
      '@packages/openapi': path.resolve(__dirname, '/src/packages/openapi'),
      '@local/pages': path.resolve(__dirname, '/src/app/pages'),
      '@local/routes': path.resolve(__dirname, '/src/app/routes'),
